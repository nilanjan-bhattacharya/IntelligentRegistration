namespace EmergencyServicesBot
{
    ...
    public class IVRBot : IDisposable, ICallingBot
    {
        ...
        private const string MainMenuPromptMessage = "Please tell me your patient id";
        ...
        private static void ProcessMainMenuSelection(RecognizeOutcomeEvent outcome, CallState callStateForClient)
        {
            ...
            {
                case "Register":
                    callStateForClient.ChosenMenuOption = "Register";
                    SetupRecording(outcome.ResultingWorkflow);
                    break;
                case "Change":
                    callStateForClient.ChosenMenuOption = "Change";
                    SetupRecording(outcome.ResultingWorkflow);
                    break;
                case "Cancel":
                    callStateForClient.ChosenMenuOption = "Cancel";
                    SetupRecording(outcome.ResultingWorkflow);
                    break;
                default:
                    SetupInitialMenu(outcome.ResultingWorkflow);
        ...
        private static Recognize CreateIvrOptions(string textToBeRead, int numberOfOptions, bool includeBack)
        {
            ...
            //}
            choices.Add(new RecognitionOption { Name = "Register", SpeechVariation = new List<string> { "register" } });
            choices.Add(new RecognitionOption { Name = "Register", SpeechVariation = new List<string> { "schedule" } });
            choices.Add(new RecognitionOption { Name = "Change", SpeechVariation = new List<string> { "change" } });
            choices.Add(new RecognitionOption { Name = "Change", SpeechVariation = new List<string> { "alter" } });
            choices.Add(new RecognitionOption { Name = "Cancel", SpeechVariation = new List<string> { "cancel" } });
            choices.Add(new RecognitionOption { Name = "Cancel", SpeechVariation = new List<string> { "remove" } });
            choices.Add(new RecognitionOption { Name = "Cancel", SpeechVariation = new List<string> { "delete" } });
        ...
        private async Task OnRecordCompleted(RecordOutcomeEvent recordOutcomeEvent)
        {
            ...
            //actions.Add(GetPromptForText(WelcomeMessage));
